  ...
  try {
    ...
    const result = await sql`
      UPDATE profile SET
        ...
        about_subtitle_en = ${data.about_subtitle_en || ""},
        about_title_en = ${data.about_title_en || ""},
        home_quote_en = ${data.home_quote_en || ""},
        hl1_title_en = ${data.hl1_title_en || ""},
        hl1_desc_en = ${data.hl1_desc_en || ""},
        hl2_title_en = ${data.hl2_title_en || ""},
        hl2_desc_en = ${data.hl2_desc_en || ""},
        hl3_title_en = ${data.hl3_title_en || ""},
        hl3_desc_en = ${data.hl3_desc_en || ""},
